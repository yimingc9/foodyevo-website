...
import FoodyEvoImg from "../public/img/foodyevo.png";
      ...
      <Container className="flex flex-wrap ">
        <div className="flex items-center w-full lg:w-1/2">
          <div className="max-w-2xl mb-8">
            ...
            Your Personal Nutrition and Budgeting Pal
            </h1>
            <p className="py-5 text-xl leading-normal text-gray-500 lg:text-xl xl:text-2xl dark:text-gray-300">
            FoodyEvo helps you develop healthy nutrition habits while keeping you wallet happy.
            Take a picture of your meal for an instant calorie and nutrition breakdown! 
            </p>
            ...
            <div className="flex flex-col items-start space-y-3 sm:space-x-4 sm:space-y-0 sm:items-center sm:flex-row">
              ...
              <a
                href="https://github.com/jennyxycai/foodyevo"
                target="_blank"
                rel="noopener"
